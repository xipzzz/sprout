    ...
    <div className="screen me">
      ...
      <main className="screen__body">
        ...
        <ul className="me__list">
          {links.map((l) => (
            <li key={l.id}>
              <button type="button" className="me__row" onClick={l.id === 'streak' ? onOpenStreak : l.id === 'quests' ? onOpenQuests : l.id === 'customize' ? onOpenCustomize : l.id === 'invite' ? onOpenInvite : l.id === 'insights' ? onOpenInsights : l.id === 'settings' ? onOpenSettings : l.id === 'words' ? () => onTabChange('words') : undefined}>
